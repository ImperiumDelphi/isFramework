...
uses
  ...
  FMX.ISWait, FMX.ISSideScroll, FMX.ISMessageDlg, FMX.ISBadge, FMX.ISPath, FMX.ISObjects, FMX.ISControls;
...
TThread.CreateAnonymousThread(
   ...
   Lista.Clear;
   Lista.BeginUpdate;
   Lista.LoadFromJsonArray('https://app.jusimperium.com.br/moveis/list.json');
   Lista.EndUpdate;
   End).Start;
end;

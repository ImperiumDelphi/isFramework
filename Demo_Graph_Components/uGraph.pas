...
uses
  ...
  FMX.ISPath, FMX.Objects, FMX.ISBase, FMX.ISBase.Presented, FMX.ISBaseButtons, FMX.ISButtons, FMX.ISPieGraph,
  ...
  FMX.ListBox, FMX.ISVectorGraph, FMX.ISPopUpMenu, FMX.ISGraphTitles, FMX.ISEditEx, FMX.ISObjects, FMX.ISControls;
...
Log.d('Control size ='+PieGraph.Width.ToString+' / '+PieGraph.Height.ToString);
